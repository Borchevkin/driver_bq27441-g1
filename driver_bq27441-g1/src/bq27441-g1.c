...
{
	uint16_t buffer;
	buffer = bq27441_g1->ReadReg(BQ27441_G1_ADDR, BQ27441_G1_REMAINING_CAPACITY_CMD);
	return buffer;
}
...
{
	bq27441_g1->WriteReg(BQ27441_G1_ADDR,BQ27441_G1_CONTROL_CMD, 0x8000);
}*/
...
{
	bq27441_g1->WriteReg(BQ27441_G1_ADDR,BQ27441_G1_DESIGN_CAPACITY_CMD, value);
}

/*void BQ27441_G1_WriteDataClass (bq27441_g1_t * bq27441_g1, uint8_t value)
{
	bq27441_g1->WriteReg(BQ27441_G1_ADDR,BQ27441_G1_DATA_CLASS_CMD, value);
...
{
	uint16_t buffer;
	bq27441_g1->WriteReg(BQ27441_G1_ADDR,BQ27441_G1_DATA_BLOCK_CMD, value);
	buffer = bq27441_g1->ReadReg(BQ27441_G1_ADDR, BQ27441_G1_DATA_BLOCK_CMD);
	return buffer;
}
...
{
	uint16_t buffer;
	buffer = bq27441_g1->ReadReg(BQ27441_G1_ADDR, BQ27441_G1_BLOCK_DATA_CMD);
	return buffer;
}*/
...
{
	uint16_t buffer;
	buffer = bq27441_g1->ReadReg(BQ27441_G1_ADDR, BQ27441_G1_BLOCK_DATA_CHECKSUM_CMD);
	return buffer;
}

void BQ27441_G1_WriteChecksum (bq27441_g1_t * bq27441_g1, uint16_t value)
{
	bq27441_g1->WriteReg(BQ27441_G1_ADDR,BQ27441_G1_BLOCK_DATA_CHECKSUM_CMD, value);
}

void BQ27441_G1_BlockDataControl (bq27441_g1_t * bq27441_g1)
{

	bq27441_g1->WriteReg(BQ27441_G1_ADDR,BQ27441_G1_BLOCK_DATA_CONTROL_CMD, 0x00);
